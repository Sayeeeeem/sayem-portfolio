    ...
    <section className="min-h-screen flex flex-col justify-center section-padding relative">
      ...
      >
        <img
          ...
          className="w-[20rem] md:w-[24rem] lg:w-[29rem] rounded-2xl object-cover shadow-xl border border-border/60"
        />
      </motion.div>
      ...
      >
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-display font-bold leading-[0.95] tracking-tight text-foreground">
          <span className="block whitespace-nowrap">{portfolioContent.hero.nameTop}</span>
          <span className="block whitespace-nowrap">{portfolioContent.hero.nameMiddle}</span>
          <span className="block whitespace-nowrap text-accent">{portfolioContent.hero.nameAccent}</span>
        </h1>
